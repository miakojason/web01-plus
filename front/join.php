...
<div class="container justify-align-center ">
  <div class="text-center mb-3">
    <img src="./icon/join.jpg">
  </div>
  <form class="form-control" action="./api/addmember.php" method="post" name="myForm">
    <table class="table table-hover" bordercolor="#6666FF">
      <tr>
        <td colspan="2">
          <p class="text-center">請填入下列資料 (標示「*」欄位請務必填寫)</p>
        </td>
      </tr>
      <tr>
        <td>*使用者帳號：</td>
        <td><input class="form-control" name="account" type="text" size="15">
          (請使用英文或數字鍵)</td>
      </tr>
      <tr>
        <td>*使用者密碼：</td>
        <td><input class="form-control" name="password" type="password" size="15">
          (請使用英文或數字鍵)</td>
      </tr>
      <tr>
        <td>*密碼確認：</td>
        <td><input class="form-control" name="re_password" type="password" size="15">
          (再輸入一次密碼)</td>
      </tr>
      <tr>
        <td>*姓名：</td>
        <td><input class="form-control" name="name" type="text" size="8"></td>
      </tr>
      <tr>
        <td>*性別：</td>
        <td>
      ...
      <tr >
        ...
        <td class="form-group row">
          <div class="col-4">
            <input class=" form-control" name="year" type="TEXT" size="2">年(民國)
          </div>
          <div class="col-4">
            <input class="form-control" name="month" type="TEXT" size="2">月
          </div>
          <div class="col-4">
            <input class="form-control" name="day" type="TEXT" size="2">日
          </div>
        </td>
      </tr>
      <tr>
        <td>電話：</td>
        <td><input class="form-control" name="telephone" type="text" size="20"></td>
      </tr>
      <tr>
        <td>行動電話：</td>
        <td><input class="form-control" name="cellphone" type="text" size="20"></td>
      </tr>
      <tr>
        <td>地址：</td>
        <td><input class="form-control" name="address" type="text" size="45"></td>
      </tr>
      <tr>
        <td>E-mail 帳號：</td>
        <td><input class="form-control" name="email" type="text" size="30"></td>
      </tr>
      <tr>
        <td>個人網站：</td>
        <td><input class="form-control" name="url" type="text" value="http://" size="40"></td>
      </tr>
      <tr>
        <td>備註：</td>
      ...
      <tr>
        <td colspan="2">
          <button class="btn btn-primary" type="button" onClick="check_data()">加入會員</button>
          <button class="btn btn-primary">重新填寫</button>
        </td>
      </tr>
    </table>
  </form>
